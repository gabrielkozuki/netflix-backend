...
public class romances extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            httpResponse = Unirest.get("https://api.themoviedb.org/3/discover/tv?api_key=038055597036fcb70b3cd616cc55c319&with_genres=10749&language=pt-BR").asJson();
            ...
            Logger.getLogger(romances.class.getName()).log(Level.SEVERE, null, ex);
        }
